    ...
    if mode[0] == 'hi':
        ...
        try:
            ...
            if lowf < 1501:
                lowf = lowf * 1000000
                hif  = hif  * 1000000
            SCPI_E5061.write(':SENS1:FREQ:STAR %G' % (lowf))
            SCPI_E5061.write(':SENS1:FREQ:STOP %G' % (hif))
        except:
            print('Failed to set frequency range.')
...
def help():
    print('Updated by Jack 1/25/2021 - new frequency range specification')
    ...
    print('s [frequency 1] [frequency 2] specifies frequency range in Hz or MHz')
